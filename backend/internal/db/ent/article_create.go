...
func (_c *ArticleCreate) SetPublishStartAt(v time.Time) *ArticleCreate {
	_c.mutation.SetPublishStartAt(v)
	return _c
}

// SetNillablePublishStartAt sets the "publish_start_at" field if the given value is not nil.
func (_c *ArticleCreate) SetNillablePublishStartAt(v *time.Time) *ArticleCreate {
	if v != nil {
		_c.SetPublishStartAt(*v)
	}
	return _c
}

// SetPublishEndAt sets the "publish_end_at" field.
func (_c *ArticleCreate) SetPublishEndAt(v time.Time) *ArticleCreate {
	_c.mutation.SetPublishEndAt(v)
	return _c
}

// SetNillablePublishEndAt sets the "publish_end_at" field if the given value is not nil.
func (_c *ArticleCreate) SetNillablePublishEndAt(v *time.Time) *ArticleCreate {
	if v != nil {
		_c.SetPublishEndAt(*v)
	}
	return _c
}
...
func (_c *ArticleCreate) SetID(v uint32) *ArticleCreate {
	_c.mutation.SetID(v)
	return _c
}

// AddCategoryIDs adds the "categories" edge to the Category entity by IDs.
func (_c *ArticleCreate) AddCategoryIDs(ids ...uint32) *ArticleCreate {
	_c.mutation.AddCategoryIDs(ids...)
	return _c
}

// AddCategories adds the "categories" edges to the Category entity.
func (_c *ArticleCreate) AddCategories(v ...*Category) *ArticleCreate {
...
func (_c *ArticleCreate) AddCommentIDs(ids ...uint32) *ArticleCreate {
...
func (_c *ArticleCreate) createSpec() (*Article, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(article.Table, sqlgraph.NewFieldSpec(article.FieldID, field.TypeUint32))
	)
	...
	if value, ok := _c.mutation.PublishStartAt(); ok {
		_spec.SetField(article.FieldPublishStartAt, field.TypeTime, value)
		_node.PublishStartAt = &value
	}
	if value, ok := _c.mutation.PublishEndAt(); ok {
		_spec.SetField(article.FieldPublishEndAt, field.TypeTime, value)
		_node.PublishEndAt = &value
	}
