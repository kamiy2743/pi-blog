...
func (_q *ArticleQuery) QueryCategories() *CategoryQuery {
...
func (_q *ArticleQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *ArticleQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *ArticleQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *ArticleQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *ArticleQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *ArticleQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ArticleQuery) WithCategories(opts ...func(*CategoryQuery)) *ArticleQuery {
	query := (&CategoryClient{config: _q.config}).Query()
...
func (_q *ArticleQuery) loadCategories(ctx context.Context, query *CategoryQuery, nodes []*Article, init func(*Article), assign func(*Article, *Category)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[uint32]*Article)
	nids := make(map[uint32]map[*Article]struct{})
...
func (_q *ArticleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(article.Table, article.Columns, sqlgraph.NewFieldSpec(article.FieldID, field.TypeUint32))
	_spec.From = _q.sql
