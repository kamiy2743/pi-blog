...
func (_q *CategoryQuery) QueryArticles() *ArticleQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, category.ArticlesTable, category.ArticlesPrimaryKey...),
		)
...
func (_q *CategoryQuery) loadArticles(ctx context.Context, query *ArticleQuery, nodes []*Category, init func(*Category), assign func(*Category, *Article)) error {
	...
	byID := make(map[uint32]*Category)
	nids := make(map[uint32]map[*Category]struct{})
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(category.ArticlesTable)
		s.Join(joinT).On(s.C(article.FieldID), joinT.C(category.ArticlesPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(category.ArticlesPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(category.ArticlesPrimaryKey[1]))
